...
# Complete Digital Coupon Admin Dashboard — Code for Claude

Share this with Claude to recreate the full application. This is a **Vite + React + TypeScript + shadcn/ui** project.
...
## 9. Campaigns Page (src/pages/CampaignsPage.tsx)
...
## 10. User Management Page (src/pages/UserManagementPage.tsx)
...
3. Install required shadcn components:
   npx shadcn add button card input label badge select switch dialog alert-dialog table tooltip toaster sonner

4. Install additional dependencies:
   npm install recharts xlsx @tanstack/react-query lucide-react date-fns

5. Copy all the code files above into src/
...
| Feature | Status |
|---|---|
| Role-based access control (RBAC) | ✅ admin/ops/viewer |
| Login with mock authentication | ✅ |
| Dashboard with KPI cards | ✅ |
| Daily histogram (Claims + PDFs) | ✅ |
| Campaign list with Excel export | ✅ |
